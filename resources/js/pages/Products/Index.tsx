...
export default function Index({ products, auth }: PageProps) {
    return (
                ...
                <div style={styles.card}>
                    {products.length === 0 ? (
                        <div style={styles.empty}>
                            ...
                            <p style={styles.emptyTitle}>Aucun produit pour l'instant</p>
                            <p style={styles.emptyText}>Commencez par ajouter votre premier produit.</p>
                            <Link href={create()} style={styles.btnPrimary}>+ Ajouter un produit</Link>
                        </div>
                    ) : (
                                    ...
                                    >
                                        ...
                                        <td style={{ ...styles.td, textAlign: 'right' }}>
                                            <div style={styles.actions}>
                                                <Link href={show(product.id)} style={styles.btnOutline}>
                                                    Voir
                                                </Link>
                                                <Link href={edit(product.id)} style={styles.btnWarning}>
                                                    Modifier
                                                </Link>
                                                <Link href={destroy(product.id)} style={styles.btnAlert}>
                                                    Supprimer
                                                </Link>
                                            </div>
                                        </td>
